...
<head>
  ...
  <title>Register - Good Procurement Service Ltd</title>
        ...
        <div class="col-xl-5 col-lg-6 ms-auto px-sm-4 align-self-center py-4">
          <div class="card card-body p-4 p-sm-5 maxw-450px m-auto rounded-4">
            ...
            <div class="text-center mb-4">
              ...
              <p>Sign up to create your secure account.</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
              ...
              <div class="mb-4">
                <label class="form-label" for="registerPhone">Phone Number <span class="text-muted">(Optional)</span></label>
                <input type="tel"
              ...
              <p class="mb-5 text-center">Already have an account? <a href="{{ route('staff.login') }}">Sign In here</a></p>
            </form>
          </div>
        </div>
      </div>
