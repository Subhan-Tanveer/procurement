...
@endphp
<div class="service-offer-box page-block pb-card-grid pb-card-grid-3">
    <div class="container">
                            ...
                            @if($card['link'] ?? false)
                                <div class="service-item-btn-prime">
                                    <a href="{{ $card['link'] }}" class="readmore-btn">
                                        <span>{{ $card['link_text'] ?? 'View Details' }}</span>
                                    </a>
                                </div>
                            @endif
                        </div>
...
@push('styles')
<style>
    .pb-card-grid-3 .service-item-image-prime img {
        aspect-ratio: 1 / 0.58;
    }
    .pb-card-grid-3 .service-item-body-prime .icon-box {
        width: 62px;
        height: 62px;
    ...
    .pb-card-grid-3 .service-item-prime:hover .icon-box {
        background-color: var(--primary-color);
        transform: scale(1.08);
    }
    .pb-card-grid-3 .service-item-body-prime .icon-box i {
        font-size: 22px;
        color: var(--white-color);
    }
    .pb-card-grid-3 .service-item-body-prime .icon-box img {
        max-width: 26px;
